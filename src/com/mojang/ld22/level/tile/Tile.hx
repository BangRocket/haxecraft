...
class Tile {
	...
	public static var ironOre:Tile = new OreTile(19, function() return com.mojang.ld22.item.resource.Resource.ironOre);
	public static var goldOre:Tile = new OreTile(20, function() return com.mojang.ld22.item.resource.Resource.goldOre);
	public static var gemOre:Tile = new OreTile(21, function() return com.mojang.ld22.item.resource.Resource.gem);
